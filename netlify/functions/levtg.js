// Netlify Function: levrg Telegram sender (CJS)
exports.handler = async (event) => {
  ...
  // normalize text/chat from various legacy shapes
  const text  = (payload.text || payload.message || "").toString().slice(0, 4096);
  const chatId= (payload.chat_id || payload.chatId || process.env.TELEGRAM_CHAT_ID || "").toString();
